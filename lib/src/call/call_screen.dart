                  ...
                  child: BlocConsumer<CallBloc, CallState>(
                    ...
                    builder: (context, state) {
                      return Column(
                        ...
                        children: [
                          Text(
                            state.callState?.getTitle(
                                    state.usernameAddressHex?.substring(0, 5) ??
                                        'Unknown') ??
                                '',
                            style:
                                TextStyles.text24.copyWith(color: Colors.white),
                          ),
                          Padding(
                            padding: EdgeInsets.only(bottom: 150.h, top: 25.h),
                            child: DecoratedBox(
